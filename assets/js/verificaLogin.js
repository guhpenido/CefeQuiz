  ...
  const unsubscribe = auth.onAuthStateChanged(async (user) => {
    if (user) {
      ...
      botaoFase1.addEventListener("click", () => {
        window.location.href = "./multiplicativo.html";
      });
      try {
          ...
          switch (fase) {
            case "1":
              botaoFase2.addEventListener("click", () => {
                window.location.href = "./permutacao.html";
              });
              mapa2.style.background =
                'url("./assets/img/fase2.png")';
              mapa1.style.background =
                'url("./assets/img/fase1ok.png")';
            ...
            case "2":
              ...
              mapa3.style.background =
                'url("./assets/img/fase3.png")';
              mapa2.style.background =
                'url("./assets/img/fase2ok.png")';
